...
### Radonix Interfaces for XY Cutter Machines
...
in this part we can investigate the relations between
...
### 3-L**imit pin** :(FAQ-Limit and Home together )
...
### 5-Inputs and Outputs that necessary in Install process
